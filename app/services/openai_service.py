...
def get_embedding(chunk: str) -> List[float]:
    """
    Get the embedding vector for a given text chunk using OpenAI API.
...
def get_llm_answer(prompt: str) -> str:
    """
    Get the answer from the language model for the given prompt.
